...
function CustomTooltip({
  ...
  return (
    <div
      className="liquid-glass p-4 min-w-45 border border-glass-border-strong"
    >
      <p
        className="text-xs font-bold mb-2 text-fg"
      >
        {label}
      </p>
      <div className="space-y-1.5">
        {payload.map((entry) => (
          ...
          >
            ...
            <span
              className="text-[11px] font-bold font-mono text-fg"
            >
      ...
      <div
        className="mt-2 pt-2 border-t border-glass-border"
      >
        <div className="flex justify-between">
          <span
            className="text-xs font-bold text-fg-dim"
          >
            Total
          </span>
          <span
                  ...
                  <div className="flex items-center gap-4">
                    {Object.entries(CATEGORY_COLORS).map(([type, color]) => (
                      <div key={type} className="flex items-center gap-1.5">
                        ...
                        />
                        <span
                          className="text-[10px] font-bold hidden sm:inline text-fg-muted"
                        >
                  ...
                  <ResponsiveContainer width="100%" height="100%">
                    ...
                    >
                      ...
                      <Tooltip
                        ...
                        cursor={{ fill: "rgba(95,217,214,0.06)" }}
                      />
                      <Bar
            ...
            <div className="lg:grid lg:grid-cols-5 lg:gap-6 space-y-6 lg:space-y-0">
                  ...
                  {Object.entries(report?.byCategory ?? {}).map(([type, data]) => {
                    const percentage =
                      report.totalRevenue > 0
                        ? Math.round((data.total / report.totalRevenue) * 100)
                        : 0;
                    return (
                      <div
                        key={type}
                      ...
                      >
                        <div className="flex items-center justify-between mb-2">
                          ...
                          <span
                            className="text-xs font-bold font-mono text-fg-muted"
                          >
                            {percentage}%
                          </span>
                        </div>
                        <div className="flex items-end justify-between">
                          <span
                            className="text-lg font-bold font-mono text-fg"
                          >
                        ...
                        <div
                          className="mt-2 h-1.5 rounded-full overflow-hidden bg-glass-hover"
                        >
                          <div
              ...
              <GlassCard className="lg:col-span-3">
                ...
                {txnsLoading ? (
                  ...
                  <p
                    className="text-center py-6 text-fg-muted"
                  >
