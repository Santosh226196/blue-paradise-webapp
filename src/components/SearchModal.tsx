  ...
  return (
    <div className="fixed inset-0 z-60 flex items-start justify-center pt-[10vh] px-4">
      ...
      >
        {/* Search input */}
        <div
          className="flex items-center gap-3 px-5 py-4" border-b border-glass-border
        >
          <IoSearch size={18} className="text-accent" />
          <input
            ref={inputRef}
            type="text"
            value={query}
            ...
            className="flex-1 bg-transparent text-sm font-medium outline-none text-fg"
          />
          <button onClick={onClose} className="text-fg-muted cursor-pointer">
            <IoClose size={18} />
          </button>
        </div>
        ...
        <div className="max-h-[50vh] overflow-y-auto">
          {query.length < 2 ? (
              ...
              {customers?.map((c) => {
                ...
                return (
                  <button
                    ...
                    className="w-full flex items-center gap-3 px-5 py-3 transition-all duration-150 text-left text-fg cursor-pointer"
                    onMouseEnter={(e) => {
            ...
            <div className="px-5 py-8 text-center">
              <IoPerson
                size={28}
                className="mx-auto mb-2 text-fg-muted"
              />
              <p className="text-sm text-fg-muted">
                No customers found
              </p>
        ...
        {/* Footer hint */}
        <div
          className="px-5 py-2.5 text-center" border-t border-glass-border
        >
          <p
