          ...
          <div className="w-full max-w-sm relative z-10 text-center animate-scale-in">
            <div className="liquid-glass relative overflow-hidden p-10">
              ...
              <div className="relative z-10">
                ...
                >
                  <IoWarning size={32} style={{ color: "var(--accent-coral)" }} />
                </div>
                ...
                {this.state.error && (
                  <div className="mt-4 p-3 rounded-xl text-left text-xs font-mono overflow-auto max-h-32"
                ...
                <button
                  ...
                  className="mt-6 w-full inline-flex items-center justify-center gap-2 px-6 py-3.5 rounded-xl text-sm font-bold text-white min-h-[48px] transition-all duration-200 active:scale-[0.97]"
